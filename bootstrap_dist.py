...
def run(is_specter: str, input_dir: str, output_dir: str, output_dir_bootstrap: str, path_labels: str):
    ...
    if is_specter:
        inp_files = [x for x in os.listdir(input_dir) if ".jsonl" in x]
        repl = ".jsonl"
    else:
...
def main():
    ...
    parser.add_argument("-s", "--is-specter", type=str, choices=["true", "false"],
    ...
    run(is_specter=args.is_specter, input_dir=args.input_dir, output_dir=args.output_dir, output_dir_bootstrap=args.output_dir_bootstrap,
